...
class USRP_MRC_Rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "USRP_MRC_Rx")
        ...
        self.qtgui_const_sink_x_0_0_1.set_update_time(0.1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_0_1_win, 2, 2, 1, 1)
        for r in range(2, 3):
        ...
        self.digital_ofdm_chanest_vcvc_0_0 = digital.ofdm_chanest_vcvc(sync_word1, sync_word2, 2, 0, 3, False)
        self.digital_ofdm_chanest_vcvc_0 = digital.ofdm_chanest_vcvc(sync_word1, sync_word2, 2, 0, 3, False)
        ...
        self.connect((self.uhd_usrp_source_0_0, 0), (self.channels_channel_model_0_0, 0))
...
def main(top_block_cls=USRP_MRC_Rx, options=None):
