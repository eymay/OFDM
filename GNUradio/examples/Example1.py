...
class Example1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "CommSim1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("CommSim1")
        ...
        self.my_matched_filter_taps = my_matched_filter_taps = firdes.root_raised_cosine(1.0, samp_rate,samp_rate/4, 0.35, 44)
        ...
        self.uhd_usrp_source_0.set_bandwidth(56000000, 0)
        ...
        self.uhd_usrp_sink_0.set_bandwidth(56000000, 0)
        ...
        self.qtgui_const_sink_x_0_2 = qtgui.const_sink_c(
            1024, #size
            "Received signal without sync", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_const_sink_x_0 = qtgui.const_sink_c(
            1024, #size
            "Received signal after sync", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.fir_filter_xxx_0 = filter.fir_filter_ccc(1, my_matched_filter_taps)
        ...
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc(.35, 4, False)
        ...
        self.connect((self.fir_filter_xxx_0, 0), (self.digital_symbol_sync_xx_0_0, 0))
        self.connect((self.fir_filter_xxx_0, 0), (self.qtgui_const_sink_x_0_2, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_my_matched_filter_taps(firdes.root_raised_cosine(1.0, self.samp_rate, self.samp_rate/4, 0.35, 44))
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate)
        self.uhd_usrp_sink_0.set_samp_rate(self.samp_rate)
        self.uhd_usrp_source_0.set_samp_rate(self.samp_rate)

    def get_my_matched_filter_taps(self):
        return self.my_matched_filter_taps

    def set_my_matched_filter_taps(self, my_matched_filter_taps):
        self.my_matched_filter_taps = my_matched_filter_taps
        self.fir_filter_xxx_0.set_taps(self.my_matched_filter_taps)
