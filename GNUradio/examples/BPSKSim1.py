...
class BPSKSim1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "BPSKSim1")
        ...
        self.my_matched_filter_taps = my_matched_filter_taps = firdes.root_raised_cosine(1.0, samp_rate,samp_rate/2, 0.35, 22)
        ...
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc(.35, 2, False)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_my_matched_filter_taps(firdes.root_raised_cosine(1.0, self.samp_rate, self.samp_rate/2, 0.35, 22))
...
def main(top_block_cls=BPSKSim1, options=None):
