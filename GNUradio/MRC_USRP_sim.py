...
class MRC_USRP_sim(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "MRC_USRP_sim")
        ...
        self.connect((self.blocks_tag_gate_0, 0), (self.blocks_throttle_0_0_0, 0))
...
def main(top_block_cls=MRC_USRP_sim, options=None):
