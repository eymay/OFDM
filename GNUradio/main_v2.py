...
class main_v2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "main_v2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("main_v2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "main_v2")
        ...
        self.qtgui_freq_sink_x_0_0 = qtgui.freq_sink_c(
            ...
            2.4e9, #fc
            samp_rate*1000, #bw
            'Frequency Domain of Received Signal', #name
            1,
            None # parent
        )
        ...
        self.blocks_throttle_0_0_1_1 = blocks.throttle(gr.sizeof_float*1, samp_rate,True)
        self.blocks_throttle_0_0_1_0_0 = blocks.throttle(gr.sizeof_float*1, samp_rate,True)
        self.blocks_throttle_0_0_1_0 = blocks.throttle(gr.sizeof_float*1, samp_rate,True)
        ...
        self.blocks_stream_to_vector_0 = blocks.stream_to_vector(gr.sizeof_gr_complex*fft_len, 1)
        ...
        self.connect((self.blocks_char_to_float_0, 0), (self.blocks_throttle_0_0_1_0, 0))
        self.connect((self.blocks_char_to_float_0_0, 0), (self.blocks_throttle_0_0_1, 0))
        self.connect((self.blocks_char_to_float_0_0_1, 0), (self.blocks_throttle_0_0_1_1, 0))
        self.connect((self.blocks_char_to_float_0_2, 0), (self.blocks_throttle_0_0_1_0_0, 0))
        ...
        self.connect((self.blocks_repack_bits_bb_0_0, 0), (self.blocks_unpack_k_bits_bb_0_0, 0))
        ...
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.blocks_char_to_float_0_2, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_0, 0), (self.blocks_char_to_float_0_0_1, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0, 0), (self.blocks_char_to_float_0_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_1, 0), (self.blocks_char_to_float_0, 0))
        ...
        self.connect((self.digital_crc32_bb_0, 0), (self.digital_map_bb_0, 0))
        ...
        self.connect((self.digital_header_payload_demux_0, 0), (self.blocks_stream_to_vector_0, 0))
        ...
        self.connect((self.digital_packet_headergenerator_bb_0, 0), (self.blocks_unpack_k_bits_bb_0_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_throttle_0_0_1_0.set_sample_rate(self.samp_rate)
        self.blocks_throttle_0_0_1_0_0.set_sample_rate(self.samp_rate)
        self.blocks_throttle_0_0_1_1.set_sample_rate(self.samp_rate)
        self.qtgui_freq_sink_x_0.set_frequency_range(2.4e9, self.samp_rate *100)
        self.qtgui_freq_sink_x_0_0.set_frequency_range(2.4e9, self.samp_rate*1000)
...
def main(top_block_cls=main_v2, options=None):
