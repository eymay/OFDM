...
g = g/norm(g);
    ...
    % Burada kendi transmitter m�zdan ald���m�z datalarla g�r�lt� ekleyip
    % random offset belirleyerek coarse time senkronizasyonu yap�yoruz
...
for SNRindx = 1:length(SNR)
    ...
    y = x_transmitted.';
    % Add random offset
    offset = randi([11 1e2]) % sim�lasyon i�in
    y = [zeros(offset,1);y];
